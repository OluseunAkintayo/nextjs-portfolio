...
const Header = () => {
	return (
		<header className='sticky top-0 w-full max-w-7xl mx-auto z-30 flex items-start justify-between py-4 xl:px-6 px-4 shadow-lg' style={{ backgroundColor: 'rgb(17, 24, 39)' }}>
